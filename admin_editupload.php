  ...
  && in_array($extension, $allowedExts)) {
    if ($_FILES["file"]["error"] > 0) {
      ...
      move_uploaded_file($_FILES["file"]["tmp_name"],
        ...
        echo "Stored in: " . $path;
  	mysql_query("update product set ProductCode='$code',ProductName='$name',ProductQuantity=$number,ProductPrice='$price',ProductDescription='$info',ProductImage='$path',AdminID=$sess_aid where ProductID=$prodid");
      }
    }
  }
    else {
      ...
      echo "<span style='font-family:Century Gothic;font-size:10.5pt;'>Product Price: $price</span><br>";
      echo "<span style='font-family:Century Gothic;font-size:10.5pt;'>Product Description: $info</span><br>";
      mysql_query("update product set ProductCode='$code',ProductName='$name',ProductQuantity=$number,ProductPrice='$price',ProductDescription='$info',AdminID=$sess_aid where ProductID=$prodid");
    }
  ?>
