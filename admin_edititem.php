...
if(isset($_POST["btnupdate"]))
{
  ...
  if($_POST["searchby"] == "Code of medicine")
  {
    ...
    {
?>
<form method="post"  enctype="multipart/form-data" action="admin_editupload.php">
<tr>
  <td></td>
  <td></td>
  <td></td>
  <td rowspan="7">Product ID<input style="width:10px;" type="text" name="prodid" value="<?php echo $row1["ProductID"] ?>" readonly="readonly"/><img src="<?php echo $row1["ProductImage"]; ?>" height="200px" width="170px"/></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Product Picture</span></td>
<td>:</td>
<td><input type="file" name="file" value="<?php echo $row1["ProductIamge"]; ?>"></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Code Of Medicine</span></td>
<td>:</td>
<td><input type="text" name="code_of_medicine" placeholder="Code of Medicine" value="<?php echo $row1["ProductCode"]; ?>"/></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Name</span></td>
<td>:</td>
<td> <input type="text" name="name" placeholder="Product Name" value="<?php echo $row1["ProductName"]; ?>"/></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Quantity</span></td>
<td>:</td>
<td> <input type="number" name="number" placeholder="Number" value="<?php echo $row1["ProductQuantity"]; ?>"/></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Price</span></td>
<td>:</td>
<td> <input type="text" name="price" placeholder="price" value="<?php echo $row1["ProductPrice"]; ?>"/></td>
</tr>
<tr>
<td><span style="font-weight:bold;">Description</span></td>
<td>:</td>
<td><textarea name="description" placeholder="Description"><?php echo $row1["ProductDescription"]; ?></textarea><td>
</tr>
<tr>
<td></td>
<td></td>
